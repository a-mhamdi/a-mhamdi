...
I enjoy programming in `Julia`, `Python`, `Matlab`, `LabVIEW`, and using `LaTeX` or `Typst` for typesetting. My OS of choice is `GNU/Linux: Ubuntu, Fedora, Manjaro`. It's a lot of fun for me to work with these tools and I feel like I learn something new every time I use them.
...
sh                        5 hrs 49 mins   >>>>>>>>-----------------   33.80 %
TeX                       5 hrs 6 mins    >>>>>>>------------------   29.62 %
Typst                     4 hrs 49 mins   >>>>>>>------------------   27.98 %
sh (RPI || Jetson Nano)   27 mins         >------------------------   02.63 %
YAML                      22 mins         >------------------------   02.18 %
```
