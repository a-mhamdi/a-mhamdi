...
I really enjoy programming in `Julia`, `Python`, `Matlab`, `LabVIEW`, and using `LaTeX` or `Typst` for typesetting. My OS of choice is `Linux`. It's a lot of fun for me to work with these tools and I feel like I learn something new every time I use them.
...
Python                    9 hrs 10 mins   >>>>>>>>>----------------   36.76 %
sh                        8 hrs 27 mins   >>>>>>>>-----------------   33.84 %
HTML                      4 hrs 26 mins   >>>>---------------------   17.77 %
Julia                     1 hr 36 mins    >>-----------------------   06.47 %
JavaScript                1 hr 11 mins    >------------------------   04.74 %
```
